...
<style>
    /* Cart page: quotation Swal width (global theme in custom/haneri-swal.css) */
                ...
                if (data && Array.isArray(data.data) && data.data.length > 0) {
                    ...
                    document.querySelector(".cart-table-container").insertAdjacentHTML(
                        ...
                        <div class="empty-cart-box">
                            ...
                            <a href="https://www.haneri.com/shop" class="empty-cart-btn">Go to Shop</a>
                        </div>
                        `
                    );
