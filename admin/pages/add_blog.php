  ...
  <div class="container-fixed">
    <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
      <div class="flex flex-col justify-center gap-2">
        <h1 class="text-xl font-medium leading-none text-gray-900">Create Blog</h1>
      </div>
  ...
  <div class="container-fixed">
    <div class="grid gap-5 grid-cols-1 lg:gap-7.5 xl:w-[74rem] mx-auto">
      <div class="card pb-2.5">
        <div class="card-header" id="blog_basic">
          <h3 class="card-title">Basic</h3>
        </div>
        <div class="card-body blog-form-grid">
          <div>
            <label class="form-label">Title *</label>
            <input class="input" id="title" placeholder="Blog title" type="text">
            <div class="field-error" data-error-for="title"></div>
          </div>
          <div>
            <label class="form-label">Slug</label>
            <input class="input" id="slug" placeholder="auto-generated if blank" type="text">
            <div class="field-error" data-error-for="slug"></div>
          </div>
          <div>
            <label class="form-label">Subtitle</label>
            <input class="input" id="sub_title" placeholder="Optional subtitle" type="text">
      ...
      <div class="card pb-2.5">
        <div class="card-header" id="blog_content_section">
      ...
      <div class="card pb-2.5">
        <div class="card-header" id="blog_seo">
          <h3 class="card-title">SEO</h3>
        </div>
        <div class="card-body blog-form-grid">
          <div>
            <label class="form-label">Meta Title</label>
            <input class="input" id="meta_title" type="text">
            <div class="field-error" data-error-for="meta_title"></div>
          </div>
          <div>
            <label class="form-label">OG Title</label>
            <input class="input" id="og_title" type="text">
            <div class="field-error" data-error-for="og_title"></div>
          </div>
          <div class="blog-form-full">
            <label class="form-label">Meta Description</label>
            <textarea class="textarea" id="meta_description"></textarea>
            <div class="field-error" data-error-for="meta_description"></div>
          </div>
          <div class="blog-form-full">
            <label class="form-label">Meta Keywords</label>
            <input class="input" id="meta_keywords" placeholder="ceiling fan, bldc, home decor" type="text">
            <div class="field-error" data-error-for="meta_keywords"></div>
          </div>
          <div class="blog-form-full">
            <label class="form-label">Canonical URL</label>
            <input class="input" id="canonical_url" placeholder="https://www.haneri.com/blog/..." type="text">
            <div class="field-error" data-error-for="canonical_url"></div>
          </div>
          <div class="blog-form-full">
            <label class="form-label">OG Description</label>
            <textarea class="textarea" id="og_description"></textarea>
            <div class="field-error" data-error-for="og_description"></div>
          </div>
          <div class="blog-form-full">
            <label class="form-label">OG Image URL</label>
            <input class="input" id="og_image" placeholder="https://..." type="text">
            <div class="field-error" data-error-for="og_image"></div>
          </div>
        </div>
      </div>

      <div class="card pb-2.5">
        <div class="card-header" id="blog_publish">
        ...
        <div class="card-body blog-form-grid">
          ...
          <div>
            ...
            <input class="input" id="published_at" type="datetime-local">
      ...
      <div class="card pb-2.5">
        <div class="card-header" id="blog_tags_faq">
          <h3 class="card-title">Tags & FAQs</h3>
        </div>
        <div class="card-body blog-form-grid">
          <div class="blog-form-full">
            <label class="form-label">Tags</label>
            <input class="input" id="tags" placeholder="tag1, tag2, tag3" type="text">
            <div class="form-help">Comma-separated tags. Backend will normalize and create missing tags.</div>
      ...
      <div class="flex justify-end gap-3">
        ...
        <button class="btn btn-primary" id="save-blog" type="button">Create Blog</button>
      </div>
    </div>
  </div>
</main>
...
(function () {
  ...
  function ensureFaqRow() {
    if (!faqWrap.querySelector("[data-faq-row]")) {
  ...
  async function submitBlog() {
    ...
    const btn = document.getElementById("save-blog");
    btn.disabled = true;
    ...
    try {
      ...
      if (!res.ok) {
        if (res.status === 422 && json && json.errors) {
          ...
          Swal.fire("Error", (json && (json.message || json.error)) || "Failed to create blog.", "error");
        }
        return;
      }
  ...
  document.getElementById("save-blog").addEventListener("click", submitBlog);
